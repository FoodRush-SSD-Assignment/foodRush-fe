    ...
    const fetchOrders = async () => {
      ...
      try {
        const response = await orderApi.get(
          "order-service/order/driver/all-orders",
          {
            headers: {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gray-50 flex justify-center items-center p-4">
        <div
          className="bg-red-50 border-l-4 border-red-500 p-4 w-full max-w-lg rounded shadow-md"
          role="alert"
        >
        ...
        {orders.length === 0 ? (
          <div className="bg-white shadow rounded-lg p-8 text-center">
            ...
            <p className="mt-4 text-gray-600">
              No orders are currently available for pickup.
            </p>
          </div>
        ) : (
                ...
                {expandedOrder === order.orderId && (
                  ...
                  >
                    ...
                    <div className="mt-4">
                      ...
                      <p className="text-gray-700">
                        {order.restaurantLocation || "Location not specified"}
                      </p>
                    </div>
