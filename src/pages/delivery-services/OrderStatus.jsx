...
const OrderStatus = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    orderApi
      .get(`order-service/order/my-orders/${orderId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  return (
    <>
      <div className="max-w-lg mx-auto p-3">
        ...
        {loading && (
          <div
            className="flex justify-center items-center h-40 bg-white rounded-lg shadow p-4"
            role="alert"
            aria-live="polite"
          >
        ...
        {error && (
          <div
            className="p-4 bg-red-50 border border-red-300 rounded-lg shadow text-center"
            role="alert"
          >
            <svg
        ...
        {orderDetails && (
          <div
            className={`transition-all duration-500 ease-in-out ${
              statusTransition ? "scale-95 opacity-80" : "scale-100 opacity-100"
            }`}
          >
                ...
                {statusSteps.map((step, index) => (
                  ...
                  >
                    ...
                    <span
                      ...
                      aria-label={`${step.replace("_", " ").toLowerCase()}`}
                    >
                      {step.replace(/_/g, " ")}
                    </span>
                    <span
                  ...
                  <div className="flex items-center text-center justify-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-red-600">
                        This order has been cancelled by delivery.
                      </p>
                    </div>
                  </div>
                </div>
