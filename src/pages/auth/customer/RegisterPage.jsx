...
import RegistrationForm from "../../../components/auth/customer/RegisterForm";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Animated blurred circles using the color palette */}
        <div
      ...
      {/* Semi-transparent mesh pattern overlay */}
      <div
